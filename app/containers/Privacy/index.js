...
export default class Privacy extends React.PureComponent {
  render() {
    return (
      ...
      imię i nazwisko, zdjęcia profilowe, numer telefonu; informacje, takie jak imię i nazwisko oraz
      adres e-mail, które podajesz w celu skonfigurowania subskrypcji naszych e-maili lub
      biuletynów; informacje wprowadzane podczas korzystania z usług na naszej stronie internetowej;
      wszelkie inne dane osobowe, które nam przesyłasz. Zanim ujawnisz nam dane osobowe innej osoby,
      ...
      personalizowania naszej strony internetowej dla Ciebie; umożliwienia korzystania z usług
      dostępnych na naszej stronie internetowej; wysyłania powiadomień e-mail, o które prosiłeś;
      zapewnienia bezpieczeństwa naszej strony internetowej i zapobieganie oszustwom; Jeśli
      prześlesz dane osobowe do publikacji w naszej witrynie, opublikujemy je i wykorzystamy w inny
      sposób zgodnie z udzieloną nam licencją. Twoje ustawienia prywatności mogą być wykorzystane do
      ograniczenia publikacji Twoich informacji na naszej stronie internetowej i mogą być
      dostosowane za pomocą kontroli prywatności na stronie. Nie będziemy bez Twojej wyraźnej zgody
      ...
      wszelkim członkom naszej grupy spółek (tzn. spółkom zależnym, głównej spółce holdingowej i jej
      spółkom zależnym), o ile jest to niezbędne do celów określonych w niniejszych „Zasadach
      ochrony prywatności”. Możemy ujawniać Twoje dane osobowe: w zakresie, w jakim jest to wymagane
      przepisami prawa; w związku z trwającymi lub potencjalnymi postępowaniami prawnymi; w celu
      ustanowienia, wyegzekwowania lub obrony naszych praw (wliczając w to udostępnienie informacji
      innym podmiotom w celu przeciwdziałania oszustwom); wszelkim osobom, które wedle naszej
      zasadnej opinii mogą wystąpić do sądu lub innego właściwego organu o ujawnienie takich danych
      osobowych, jeśli wedle zasadnej rozsądnej opinii, istnieje duże prawdopodobieństwo, że taki
      sąd lub organ nakaże ujawnienie takich danych osobowych Z wyjątkiem postanowień zawartych w
      ...
      przechowywane dłużej niż jest to konieczne do tego celu lub tych celów. Niezależnie od innych
      postanowień niniejszej sekcji zachowamy dokumenty (w tym dokumenty elektroniczne) zawierające
      dane osobowe: w zakresie, w jakim jest to wymagane przepisami prawa; jeśli uważamy, że
      dokumenty mogą mieć znaczenie dla wszelkich toczących się lub przyszłych postępowań sądowych;
      ...
      Wszystkie elektroniczne transakcje finansowe zawierane za pośrednictwem naszej strony
      internetowej będą chronione technologią szyfrowania. Użytkownik przyjmuje do wiadomości, że
      transmisja informacji przez Internet jest potencjalnie niebezpieczna i bezpieczeństwo
      przesłanych w ten sposób danych nie jest gwarantowane. Jesteś odpowiedzialny za zachowanie
      ...
      przesyłane na serwer za każdym razem, gdy przeglądarka wyśle żądanie otwarcia strony
      znajdującej się na serwerze. Pliki cookie mogą być „trwałymi” lub „sesyjnymi” plikami cookie:
      trwałe pliki cookie będą przechowywane przez przeglądarkę internetową i pozostaną ważne do
      ustalonej daty wygaśnięcia, chyba że użytkownik usunie je przed datą wygaśnięcia; sesyjny plik
      cookie wygasa z końcem sesji użytkownika, gdy przeglądarka internetowa jest zamykana. Pliki
      cookie zazwyczaj nie zawierają żadnych informacji identyfikujących użytkownika, ale dane
