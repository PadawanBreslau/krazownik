...
const LoggedOutPanel = () => (
  <div className={styles.buttons}>
    <Link to="/login">
      <LoginIcon style={{ marginLeft: 10 }} width={40} height={40} cursor="pointer" title="Zaloguj się"/>
    </Link>
    <Link to="/register">
      <RegisterIcon style={{ marginLeft: 10 }} width={40} height={40} cursor="pointer" alt="Zarejestruj się"/>
    </Link>
  </div>
);
